package com.formacionbdi.microservicios.app.oauth.security.event;
...
import com.formacionbdi.microservicios.app.oauth.services.IUsuarioService;
...
public class AuthenticationSuccessErrorHandler implements AuthenticationEventPublisher {
	...
	public void publishAuthenticationSuccess(Authentication authentication) {
		...
		//Resetea el intento debido a que fue succes
	...
	public void publishAuthenticationFailure(AuthenticationException exception, Authentication authentication) {
		...
		try {
			...
			usuarioService.update(usuario, usuario.getId());
			tracer.currentSpan().tag("errror.mensaje", errors.toString());
